...
/**
 * Full application against the embedded PostgreSQL. Flyway migrates as {@code trillopos_owner};
 * the pool connects as {@code trillopos_app}. The membership cache is off so status changes are
...
public abstract class IntegrationTest {
    ...
    static void database(DynamicPropertyRegistry registry) {
        ...
        registry.add("trillopos.tenant.membership-cache-ttl", () -> "0s");
    }
}
