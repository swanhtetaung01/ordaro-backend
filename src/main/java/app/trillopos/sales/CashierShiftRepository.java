...
public interface CashierShiftRepository extends JpaRepository<CashierShift, UUID> {
    ...
    @Query("""
            ...
            where p.saleId = s.id and s.cashierShiftId = :shift
              and s.status in :statuses and p.method = app.trillopos.sales.PaymentMethod.CASH""")
    ...
    @Query("""
            ...
            where r.cashierShiftId = :shift and r.method = app.trillopos.sales.PaymentMethod.CASH""")
    ...
    @Query("""
            ...
            where p.cashierShiftId = :shift and p.method = app.trillopos.sales.PaymentMethod.CASH""")
    ...
    @Query("""
            ...
            where e.cashierShiftId = :shift and e.voidedAt is null
              and e.method = app.trillopos.finance.ExpenseMethod.CASH""")
