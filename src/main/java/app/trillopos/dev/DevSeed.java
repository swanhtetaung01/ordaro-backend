...
import app.trillopos.catalog.Category;
import app.trillopos.catalog.CategoryRepository;
...
class DevSeed implements ApplicationRunner {
    ...
    DevSeed(AuthService auth, AccountRepository accounts, MembershipDirectory directory,
            ...
            @Value("${trillopos.seed.phone:+959000000001}") String phone,
            @Value("${trillopos.seed.password:demo-password}") String password) {
        this.auth = auth;
