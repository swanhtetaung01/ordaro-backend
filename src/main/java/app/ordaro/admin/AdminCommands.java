...
/**
 * {@code java -jar ordaro-backend.jar admin <command> [argument]}: the application without its
 ...
 */
@Component
@ConditionalOnProperty("ordaro.admin.command")
public class AdminCommands implements ApplicationRunner, ExitCodeGenerator {
    ...
    public static int launch(Class<?> application, String[] args) {
        ...
        app.setDefaultProperties(Map.of("ordaro.admin.command", command, "logging.level.root", "WARN"));
    ...
    public void run(ApplicationArguments args) {
        String command = environment.getProperty("ordaro.admin.command", "help");
